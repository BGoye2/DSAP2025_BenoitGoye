...
class ModelComparator:
    ...
    def __init__(self, data_path='output/processed_data.csv'):
        """
    ...
    def _load_data(self):
        ...
        try:
            ...
            print("Warning: feature_names.csv not found")
            return
        ...
        print(f"Data loaded: {len(X)} samples, {len(self.feature_names)} features")
    
    def _load_models(self):
        """Train models on-demand (no .pkl files used)"""
...
def main():
    """Main execution"""
    comparator = ModelComparator('output/processed_data.csv')
