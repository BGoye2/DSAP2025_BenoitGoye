...
COUNTRY_REGIONS = {
    # East Asia & Pacific
    'CHN': 'East Asia & Pacific', 'IDN': 'East Asia & Pacific', 'JPN': 'East Asia & Pacific',
    'KHM': 'East Asia & Pacific', 'KOR': 'East Asia & Pacific', 'LAO': 'East Asia & Pacific',
    'MMR': 'East Asia & Pacific', 'MNG': 'East Asia & Pacific', 'MYS': 'East Asia & Pacific',
    'PHL': 'East Asia & Pacific', 'PNG': 'East Asia & Pacific', 'THA': 'East Asia & Pacific',
    'TLS': 'East Asia & Pacific', 'VNM': 'East Asia & Pacific', 'FJI': 'East Asia & Pacific',
    'AUS': 'East Asia & Pacific', 'NZL': 'East Asia & Pacific', 'HKG': 'East Asia & Pacific',
    'SGP': 'East Asia & Pacific', 'BRN': 'East Asia & Pacific',
    ...
    'MKD': 'Europe & Central Asia', 'MDA': 'Europe & Central Asia', 'MNE': 'Europe & Central Asia',
    ...
    'UKR': 'Europe & Central Asia', 'GBR': 'Europe & Central Asia', 'UZB': 'Europe & Central Asia',

    # Latin America & Caribbean
    'ARG': 'Latin America & Caribbean', 'BLZ': 'Latin America & Caribbean', 'BOL': 'Latin America & Caribbean',
    ...
    'PRY': 'Latin America & Caribbean', 'PER': 'Latin America & Caribbean', 'SUR': 'Latin America & Caribbean',
    'TTO': 'Latin America & Caribbean', 'URY': 'Latin America & Caribbean', 'VEN': 'Latin America & Caribbean',
    'ATG': 'Latin America & Caribbean', 'BHS': 'Latin America & Caribbean', 'BRB': 'Latin America & Caribbean',
    ...
    'LBN': 'Middle East & North Africa', 'LBY': 'Middle East & North Africa', 'MLT': 'Middle East & North Africa',
    'MAR': 'Middle East & North Africa', 'OMN': 'Middle East & North Africa', 'QAT': 'Middle East & North Africa',
    'SAU': 'Middle East & North Africa', 'SYR': 'Middle East & North Africa', 'TUN': 'Middle East & North Africa',
    'ARE': 'Middle East & North Africa', 'PSE': 'Middle East & North Africa', 'YEM': 'Middle East & North Africa',
    ...
    'SDN': 'Sub-Saharan Africa', 'TZA': 'Sub-Saharan Africa', 'TGO': 'Sub-Saharan Africa',
...
class SegmentationAnalyzer:
    ...
    def create_income_segments(self) -> pd.Series:
        """
    ...
    def create_regional_segments(self) -> pd.Series:
        """
        ...
        if 'country_code' not in self.data.columns:
            print("Warning: country_code column not found. Cannot create regional segments.")
            print("Creating placeholder segments based on data order.")
            # Fallback to simple grouping
            n = len(self.data)
            return pd.Series(['Region ' + str(i % 3 + 1) for i in range(n)], index=self.data.index)
    ...
    def train_models_by_segment(self, segments: pd.Series, segment_name: str) -> Dict:
        """
    ...
    def create_feature_importance_heatmap(self, results: Dict, segment_name: str,
                                         output_file: str, model_name: str = 'XGBoost') -> None:
        """
    ...
    def save_results_to_csv(self, results: Dict, segment_name: str, output_file: str) -> None:
        """
    ...
    def create_summary_report(self, income_results: Dict, regional_results: Dict) -> None:
        """
        ...
        with open('output/segmentation_summary_report.txt', 'w') as f:
            ...
            f.write("1. Performance varies across income levels, suggesting different\n")
            f.write("   inequality dynamics in countries at different development stages.\n\n")

            f.write("2. Feature importance rankings differ by segment, indicating that\n")
            f.write("   policies should be tailored to country context.\n\n")

            f.write("3. Model accuracy (R²) tends to be higher in larger segments with\n")
            f.write("   more homogeneous characteristics.\n\n")
